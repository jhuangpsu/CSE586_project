...
class MVSDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for i in range(self.args.nsrc):
            ...
            # self.src_img_files.append(src_img_file)
        ...
        #     self.src_cam_files.append(cam_file)
        # print(f'src_cam_files\n {self.src_cam_files}')
        # print(f'src_img_files\n {self.src_img_files}')
        ## 3. Read Depth Maps
        ...
        # print(f'id:{ref_img_file} \n camfile: {cam_file}Intrinsic:\n{intrinsics}\n Extrinsics:\n{extrinsics}')
